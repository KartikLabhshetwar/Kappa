...
- **generateComponent**: Create React/TypeScript components with TailwindCSS styling and usage examples using Google Gemini 2.5 Flash.
...
- **React components** → use generateComponent with Google Gemini 2.5 Flash (never write code directly)
...
4. **IMMEDIATELY follow up with generateComponent using Google Gemini 2.5 Flash and the results**
...
- For generateComponent: Show the complete component code using \`\`\`tsx blocks (generated by Google Gemini 2.5 Flash)
...
- When using generateComponent tool with Google Gemini 2.5 Flash, ALWAYS include the generated code in your main response
...
- Use \`generateComponent\` tool with Google Gemini 2.5 Flash for React components
- Specify language as \`\`\`tsx\` for React/TypeScript

**IMPORTANT: For React components, use generateComponent tool with Google Gemini 2.5 Flash, not direct code!**
`;
...
- **Purpose**: Generate production-ready React components from API documentation and structured data using Google Gemini 2.5 Flash
- **AI Model**: ALWAYS uses Google Gemini 2.5 Flash (gemini-2.5-flash) for component generation regardless of chat model selection
- **Capabilities**:
  - AI-powered component generation with API integration using Gemini 2.5 Flash
  - TypeScript-first development with proper interfaces
  - Multiple component types (forms, tables, displays, interactive, payment, billing, subscription)
...
- **Gemini 2.5 Flash**: All component generation uses Google Gemini 2.5 Flash for high quality and optimal quality
...
- **AI Model**: Always uses Google Gemini 2.5 Flash for component generation, regardless of chat model
